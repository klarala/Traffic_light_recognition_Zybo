...
#
# Generated by export_simulation on Tue Dec 07 13:54:50 CET 2021
#
################################################################################
...
'-reset_run' switch to the './vpm_0.sh' script.
...
./vpm_0.sh -noclean_files

For more information on the script, please type './vpm_0.sh -help'.

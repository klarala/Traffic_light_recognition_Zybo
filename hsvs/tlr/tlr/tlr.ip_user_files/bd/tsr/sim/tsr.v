...
(* CORE_GENERATION_INFO = "tsr,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=tsr,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=7,numReposBlks=7,numNonXlnxBlks=3,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "tsr.hwdef" *) 
module tsr
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire sys_clock_1;
  wire vpm_0_de_out;
  wire vpm_0_h_sync_out;
  wire [23:0]vpm_0_pixel_out;
  wire vpm_0_v_sync_out;
  ...
  tsr_rgb2vga_0_0 rgb2vga_0
       (.PixelClk(dvi2rgb_0_PixelClk),
        .rgb_pData(vpm_0_pixel_out),
        .rgb_pHSync(vpm_0_h_sync_out),
        .rgb_pVDE(vpm_0_de_out),
        .rgb_pVSync(vpm_0_v_sync_out),
  ...
  tsr_vpm_0_0 vpm_0
       (.clk(dvi2rgb_0_PixelClk),
        ...
        .h_sync_out(vpm_0_h_sync_out),
        .pixel_in(dvi2rgb_0_vid_pData),
        .pixel_out(vpm_0_pixel_out),
        .v_sync_in(dvi2rgb_0_vid_pVSync),
        .v_sync_out(vpm_0_v_sync_out));

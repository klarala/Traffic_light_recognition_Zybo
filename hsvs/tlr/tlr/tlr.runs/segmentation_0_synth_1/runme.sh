...
HD_PWD='/home/lsriw/Desktop/klara/hsvs1/hsvs/tlr/tlr/tlr.runs/segmentation_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log segmentation_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source segmentation_0.tcl

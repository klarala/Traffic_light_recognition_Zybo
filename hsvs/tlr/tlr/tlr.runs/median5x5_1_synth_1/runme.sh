...
HD_PWD='/home/lsriw/Desktop/klara/hsvs1/hsvs/tlr/tlr/tlr.runs/median5x5_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log median5x5_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source median5x5_1.tcl

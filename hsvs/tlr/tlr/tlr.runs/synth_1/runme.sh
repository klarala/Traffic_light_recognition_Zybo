...
HD_PWD='/home/lsriw/Desktop/klara/hsvs1/hsvs/tlr/tlr/tlr.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tsr_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tsr_wrapper.tcl

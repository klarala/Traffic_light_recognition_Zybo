...
HD_PWD='/home/lsriw/Desktop/klara/hsvs1/hsvs/tlr/tlr/tlr.runs/tsr_median5x5_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tsr_median5x5_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tsr_median5x5_0_0.tcl

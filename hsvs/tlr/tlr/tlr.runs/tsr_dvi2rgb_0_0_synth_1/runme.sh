...
HD_PWD='/home/lsriw/Documents/Camugli/hsvs/tlr/tlr/tlr.runs/tsr_dvi2rgb_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tsr_dvi2rgb_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tsr_dvi2rgb_0_0.tcl

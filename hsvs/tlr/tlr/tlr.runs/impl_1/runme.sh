...
HD_PWD='/home/lsriw/Desktop/klara/hsvs1/hsvs/tlr/tlr/tlr.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tsr_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tsr_wrapper.tcl -notrace

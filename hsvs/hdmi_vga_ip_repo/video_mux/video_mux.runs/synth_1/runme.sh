...
HD_PWD='/home/tomasz/skrypty/skrypt_psra/solution/ip_repo/video_mux/video_mux.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log video_mux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source video_mux.tcl
